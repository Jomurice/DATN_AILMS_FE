<template>
  <div class="container m-0 p-4">
    <p class="link fs-4" @click="showform = false"> < </p>
...
async function editUser(id) {
  ...
  try {
    ...
    form.value = { ...user, role: user.roles[0] };
    showform.value = true;
  } catch (error) {
...
async function resetForm() {
  form.value = { id: null, username: '', name: '', password: '', gender: true, phone: '', dob: null, address: '', email: '', role: 'User' }
