                ...
                <tr v-for="z in items" :key="z.id">
                  ...
                  <td class="text-center">
                    <div class="d-flex gap-2 justify-content-center">
                      ...
                      <RouterLink class="btn btn-sm btn-outline-secondary btn-ctl" :to="`/warehouse/${wid}/zone/${z.id}/aisle`">Xem dãy</RouterLink>
...
async function submit() {
  ...
  else await zoneService.create(wid, form.value);
  await load();
  ui.value = "list";
}
