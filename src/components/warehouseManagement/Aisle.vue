      ...
      <main class="main">
                ...
                <tr v-for="a in pagedItems" :key="a.id">
                  ...
                  <td class="text-center">
                    <div class="row-actions">
                      ...
                      <!-- Xem kệ (ICON như sidebar) -->
                      <RouterLink
                        class="icon-view"
                        :to="`/warehouse/${wid}/zone/${zid}/aisle/${a.id}/shelf`"
                        title="Xem kệ"
                      >
            ...
            <form class="row g-3" @submit.prevent="submit">
              <div class="col-md-6">
                <label class="form-label"
                  >Tên dãy <span class="text-danger">*</span></label
                >
              ...
              <div class="col-12 small text-muted">
                Kho: {{ path.whName }} — Khu: {{ path.zName }}
              </div>
              <div class="col-12">
        ...
        <div v-else-if="ui === 'detail'" class="section-card">
          ...
          <div class="card border-0 shadow-sm p-4">
            ...
            <div class="mb-2">
              <small class="text-muted">Khu</small>
              <div>{{ path.zName || "—" }}</div>
            </div>
                  ...
                  <tr v-for="s in shelves" :key="s.id">
                    ...
                    <td>
                      <RouterLink
                        ...
                        :to="`/warehouse/${wid}/zone/${zid}/aisle/${detail.id}/shelf/${s.id}/bin`"
...
async function load() {
  items.value = (await aisleService.getByZone(zid)) || [];
}
...
async function submit() {
  if (isEdit.value) {await aisleService.update(editingId.value, form.value)}
    ...
    const payload = {...form.value, zoneId: zid}
    await aisleService.create(payload);
  }
  await load();
  ui.value = "list";
}
